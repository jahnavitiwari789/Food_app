  ...
  return (
    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 bg-primary md:px-16">
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <motion.img whileTap={{scale:0.6}} src={user ? user.photoURL : Avatar} className="w-10 min-w-[40px] h-10 min-h-[40px] drop-shadow-xl cursor-pointer rounded-full"alt="User profile" onClick={login}></motion.img>
        ...
        { isMenu &&(
          ...
          <p className="px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-200 transition-all duration-100 ease-in-out text-textColor text-base" onClick={logout}>Log Out <MdLogout></MdLogout></p>
        </motion.div>
        )
        }
      ...
      <div className="flex  items-center justify-between md:hidden w-full h-full">
        ...
        { isMenu &&(
         ...
         <ul className="flex flex-col">
          ...
          <p className="m-2 p-2 flex items-center gap-3 rounded-md shadow-md justify-center bg-slate-200 cursor-pointer hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base" onClick={logout}>Log Out <MdLogout></MdLogout></p>
        </motion.div>
        )
        }
