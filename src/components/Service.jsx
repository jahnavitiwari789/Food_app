...
const Service = () => {
  return (
    ...
    <section  className='relative' >
        <div  className=' bg-[url("./img/bg.jpg")] w-full h-[100%]  bg-no-repeat  object-contain backdrop-blur-lg  bg-cover '> 
        ...
        <div className="flex md:flex-row flex-col  item-center justify-center">
            <div className="p-[34px]">
                <img src={Logo1} alt="Our Client" className='h-[124px]  '/>
            </div>
            <div className="p-[34px]">
                <img src={Logo2} alt="Our Client" className='h-[124px] '/>
            </div>
          
            <div className="p-[34px]">
                <img src={Logo3} alt="Our Client" className='h-[124px]'/>
            </div>
            <div className="p-[34px]">
                <img src={Logo4} alt="Our Client" className='h-[124px] '/>
            </div>
        </div>
        </div>
    </section>
